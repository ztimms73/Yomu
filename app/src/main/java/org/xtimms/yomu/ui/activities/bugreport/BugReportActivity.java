package org.xtimms.yomu.ui.activities.bugreport;
...
import org.xtimms.yomu.misc.DialogAsyncTask;
import org.xtimms.yomu.ui.activities.bugreport.model.DeviceInfo;
import org.xtimms.yomu.ui.activities.bugreport.model.Report;
import org.xtimms.yomu.ui.activities.bugreport.model.github.ExtraInfo;
import org.xtimms.yomu.ui.activities.bugreport.model.github.GithubLogin;
import org.xtimms.yomu.ui.activities.bugreport.model.github.GithubTarget;
import org.xtimms.yomu.ui.base.AbsThemeActivity;
...
public class BugReportActivity extends AbsThemeActivity {
    ...
    private static final String ISSUE_TRACKER_LINK = "https://github.com/Sketchupper/Yomu/issues";
    ...
    private void sendBugReport(GithubLogin login) {
        ...
        GithubTarget target = new GithubTarget("Sketchupper", "Yomu");
